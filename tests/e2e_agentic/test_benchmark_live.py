...
these to drive a real (or ``--dry-run``) benchmark cell:
    ...
    pytest tests/e2e_agentic/test_benchmark_live.py --dry-run --arm A7 -q
    pytest tests/e2e_agentic/test_benchmark_live.py::test_t3_run --arm A10
...
from tests.e2e_agentic.scenarios.benchmark import (
    AddToolScenario,
    AdaptHpcScenario,
