...
records exactly ONE result row.
    ...
    python -m tests.e2e_agentic.run_cell --arm A10 --test t3_run --rep 1 \
    ...
    python -m tests.e2e_agentic.run_cell --arm A7 --test t3_run --rep 1 --dry-run
...
from tests.e2e_agentic.harness.cell import (
...
from tests.e2e_agentic.scenarios.arms import ARM_BY_ID, ARMS, DEFAULT_ARM
...
def _project_root() -> Path:
    # tests/e2e_agentic/run_cell.py -> repo root is parents[2].
