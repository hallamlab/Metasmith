...
records exactly ONE result row.
    ...
    python -m tests.e2e.agentic.run_cell --arm A10 --test t3_run --rep 1 \
    ...
    python -m tests.e2e.agentic.run_cell --arm A7 --test t3_run --rep 1 --dry-run
...
from tests.e2e.agentic.harness.cell import (
    DEFAULT_METASMITH_ENV_NAME,
    prepare_sandbox,
)
from tests.e2e.agentic.harness.checker import run_checker
...
from tests.e2e.agentic.scenarios.arms import ARM_BY_ID, ARMS, DEFAULT_ARM
from tests.e2e.agentic.scenarios.base import PromptContext, VerifyContext
from tests.e2e.agentic.scenarios.benchmark import BENCHMARK_SCENARIOS
