...
inputs.Add(
    items = [
        (base_dir / "sample_data/accession_short", "fastq_short", "std::short_reads_accession"),
        (base_dir / "sample_data/accession_long.fastq", "fastq_long", "std::long_reads_filtered"),
    ]
)
