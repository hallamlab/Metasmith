#!/usr/bin/env python3
"""fba_from_genome -- a workflow 28 public KBase narratives ran.

Reconstructed from narrative 162370/1 (untitled), whose app cells wire:

    1. fba_tools/build_metabolic_model
    2. fba_tools/run_flux_balance_analysis
    3. fba_tools/run_flux_balance_analysis

The mask `w_s0004` holds exactly those apps. Solving against the whole
...
NAME = "fba_from_genome"
DESCRIPTION = """
build_metabolic_model -> run_flux_balance_analysis -> run_flux_balance_analysis. Seen in 28 public narratives.
"""
...
def build_spec(rebuild: bool = False) -> Spec:
    ...
    return Spec(
        ...
        transform_libraries=A.transforms("w_s0004"),
