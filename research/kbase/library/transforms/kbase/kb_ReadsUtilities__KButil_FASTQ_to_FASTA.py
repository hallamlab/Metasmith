...
"""kb_ReadsUtilities/KButil_FASTQ_to_FASTA -- Convert FASTQ to FASTA - v1.0.1

KBase app   : kb_ReadsUtilities/KButil_FASTQ_to_FASTA (spec 1.2.2, inactive)
module      : kb_ReadsUtilities
git         : https://github.com/kbaseapps/kb_ReadsUtilities @ de8955d0a9f373bff40882a02cd7742aa7560eea
service     : kb_ReadsUtilities.KButil_FASTQ_to_FASTA
