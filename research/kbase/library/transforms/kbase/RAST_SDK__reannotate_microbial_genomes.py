...
"""RAST_SDK/reannotate_microbial_genomes -- Annotate Multiple Microbial Genomes with RASTtk - v1.073

KBase app   : RAST_SDK/reannotate_microbial_genomes (spec 1.9.5, active)
module      : RAST_SDK
