...
"""kb_uploadmethods/import_fastq_sra_as_reads_from_staging -- Import FASTQ/SRA File as Reads from Staging Area

KBase app   : kb_uploadmethods/import_fastq_sra_as_reads_from_staging (spec 1.0.57, inactive)
