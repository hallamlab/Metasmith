...
**Of the 235 active KBase apps, 216 became metasmith transforms.**
Across all 493 apps in the catalog, 371 converted.
...
- **polymorphic_output** — an output parameter accepting more than 8 workspace
  types. These are generic object shufflers, not workflow steps.

## Library

189 data types, 106 tool environments, 371 transforms.
