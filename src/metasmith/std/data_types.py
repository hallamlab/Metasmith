...
def StdTypes() -> DataTypeLibrary:
    ...
    std_data_types["long_reads_assembly"] = Endpoint.Unpack({
        "properties": {
            "format": "Directory",
            "data": "Long read assembly generated by Flye"
        }
    })
    std_data_types["hybrid_assembly"] = Endpoint.Unpack({
        "properties": {
            "format": "Directory",
            "data": "Hybrid assembly generated by Pilon"
        }
    })
    std_data_types["short_reads_filtered"] = Endpoint.Unpack({
        "properties": {
            "format": "Sequence file",
    ...
    std_data_types["short_reads_assembly"] = Endpoint.Unpack({
        "properties": {
            "format": "Directory",
            "data": "Short read assembly generated by MEGAHIT"
        }
    })
