...
out_sam         = model.AddProduct(lib.GetType("std::sequence_alignment_map_long"))
out_bam         = model.AddProduct(lib.GetType("std::binary_alignment_map_long"))
out_bam_csi     = model.AddProduct(lib.GetType("std::binary_alignment_map_csi_long"))
