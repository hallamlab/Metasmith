...
not remove it. See research/kbase/curation/r4/analyses.md. the `off` arm;
asv_pipeline.nf:2726-2729 falls back to files on disk if they exist and a
zero-row placeholder if not.
