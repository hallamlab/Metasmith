...
chunk_out   = model.AddRequirement(lib.GetType("annotation::interproscan_results_chunk"), parents={parent_orfs})
merged      = model.AddProduct(lib.GetType("annotation::interproscan_results"))
