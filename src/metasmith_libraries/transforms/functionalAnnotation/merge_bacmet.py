...
chunk_out   = model.AddRequirement(lib.GetType("annotation::bacmet_diamond_results_chunk"), parents={parent_orfs})
merged      = model.AddProduct(lib.GetType("annotation::bacmet_diamond_results"))
