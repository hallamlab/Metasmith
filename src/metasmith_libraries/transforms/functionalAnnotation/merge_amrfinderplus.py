...
chunk_out   = model.AddRequirement(lib.GetType("annotation::amrfinderplus_results_chunk"), parents={parent_orfs})
merged      = model.AddProduct(lib.GetType("annotation::amrfinderplus_results"))
