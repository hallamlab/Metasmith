...
chunk_out   = model.AddRequirement(lib.GetType("annotation::vfdb_diamond_results_chunk"), parents={parent_orfs})
merged      = model.AddProduct(lib.GetType("annotation::vfdb_diamond_results"))
