...
chunk_out   = model.AddRequirement(lib.GetType("annotation::diamond_tcdb_results_chunk"), parents={parent_orfs})
merged      = model.AddProduct(lib.GetType("annotation::diamond_tcdb_results"))
