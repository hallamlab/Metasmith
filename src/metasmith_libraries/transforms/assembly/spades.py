...
def protocol(context: ExecutionContext):
    ...
    _bbcms_cmd = f"""\
        ...
        """
    context.ExecWithEnv() \
        .ifContainerDo(env=img_bbt, cmd=_bbcms_cmd) \
        .ifVirtualEnvDo(env=img_bbt, cmd=_bbcms_cmd)
    ...
    _cmd = f"""\
        ...
        """
    context.ExecWithEnv() \
        .ifContainerDo(env=img_sp, cmd=_cmd) \
        .ifVirtualEnvDo(env=img_sp, cmd=_cmd)
    ...
    _filter_cmd = f"""\
        ...
        """
    context.ExecWithEnv() \
        .ifContainerDo(env=img_bbt, cmd=_filter_cmd) \
        .ifVirtualEnvDo(env=img_bbt, cmd=_filter_cmd)
